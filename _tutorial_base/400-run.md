...
![Run tab]({{ site.baseurl }}/img/tutorial_base/run-run-0.png)
...
![Initial Requirements]({{ site.baseurl }}/img/tutorial_base/run-require-0.png)
...
![Resolve result]({{ site.baseurl }}/img/tutorial_base/run-require-1.png)
...
![Run bundles]({{ site.baseurl }}/img/tutorial_base/run-require-2.png)
...
![Running]({{ site.baseurl }}/img/tutorial_base/run-launch-0.png)
